...
namespace OrderPizzaBot.Dialogs
{
	public class OrderPizzaDialog : DialogBase
	{
		...
		private async Task<DialogTurnResult> StartPizzaConfigurationAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
		{
			...
			var endMsg = "¡Estupendo! ¡Por ahora esto es todo! ¡Vamos al siguiente paso del taller! ¡Pero eh! ¡Ya tenemos el número de pizzas y el tipo de pedido, y podemos confirmar con mensajes distintos al sí y no gracias a las validaciones personalizadas!";
