...
namespace OrderPizzaBot.Bots
{
	public class OrderPizzaBot : ActivityHandler
	{
		...
		public OrderPizzaBot(ConversationState conversationState, UserState userState, OrderPizzaRecognizer recognizer, IPizzaRepository pizzaRepository, IIngredientRepository ingredientRepository)
		{
			...
			_dialog = new MainDialog(_recognizer, userState, _pizzaRepository, _ingredientRepository);
		}
