...
namespace OrderPizzaBot.Constants
{
	public static class BotConstants
	{
		...
		public static readonly IReadOnlyDictionary<int, string> DeliveryStateMessages = new Dictionary<int, string>
		{
		...
		public static readonly IReadOnlyDictionary<int, string> PickupStateMessages = new Dictionary<int, string>
		{
			{0, "¡Tu pedido aún está en la cola! ¡Espera un poco!" },
			{  1, "¡Nuestros cocineros ya están preparando tu pedido!" },
			{ 7,  "¡Tu pedido está en el horno!" },
